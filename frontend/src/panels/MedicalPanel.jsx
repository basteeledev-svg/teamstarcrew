// Kept for backwards compat — use LifeSupportPanel instead.
export default function MedicalPanel({ gameState, sendCommand }) {
  return <BlankPanel name="MEDICAL BAY" icon="✚" color="#44ffcc" />
}
